...
class MexicoQuakeKeysLookup(OasisBaseKeysLookup):
    ...
    def process_location(self, loc, peril_id, coverage_type):
        ...
        data={
            ...
            "shortcolumn": loc['shortcolumn'],
            "locuserdef1": loc['locuserdef1'],
            "pounding": loc['pounding'],
            "locuserdef2": loc['locuserdef2'],
            "shapeirregularity": loc['shapeirregularity'],
            "buildinghsape": loc['buildingshape'],
            "locuserdef3": loc['locuserdef3'],
            "fatigue": loc['fatigue'],
            "locuserdef4": loc['locuserdef4'],
            "yearupgraded": loc['yearupgraded'],
